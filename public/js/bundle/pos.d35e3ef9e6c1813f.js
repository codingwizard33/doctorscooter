...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: _objectSpread(_objectSpread(_objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_6__.mapActions)(["changeSidebarProperties", "changeThemeMode", "logout"])), (0,vuex__WEBPACK_IMPORTED_MODULE_6__.mapGetters)(["currentUser"])), {}, (_objectSpread2 = {
    ...
    nprogress__WEBPACK_IMPORTED_MODULE_0___default().start();
    nprogress__WEBPACK_IMPORTED_MODULE_0___default().set(0.1);
    axios.get("pos/get_products_pos?page=" + page + "&category_id=" + this.category_id + "&brand_id=" + this.brand_id + "&warehouse_id=" + this.sale.warehouse_id + "&stock=" + 1).then(function (response) {
...
var render = function render() {
  ...
  return _c("div", {
  ...
  }, [_c("span", [_vm._v(_vm._s(_vm.$t("Total_Payable")) + " : " + _vm._s(_vm.currentUser.currency) + " " + _vm._s(_vm.GrandTotal.toFixed(2)))])])]), _vm._v(" "), _c("b-col", {
    attrs: {
      lg: "4",
      md: "4",
      sm: "12"
    ...
    attrs: {
      type: "submit",
      variant: "success ripple mt-1 btn-rounded btn-block"
    }
  }, [_c("i", {
